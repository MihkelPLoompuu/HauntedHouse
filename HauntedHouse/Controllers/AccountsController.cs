...
namespace HauntedHouse.Controllers
{
    public class AccountsController : Controller
    {
        ...
        public AccountsController(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, HauntedHouseContext context, IEmailsServices emailsservices, IPlayerProfilesServices playerProfilesServices)
        {
